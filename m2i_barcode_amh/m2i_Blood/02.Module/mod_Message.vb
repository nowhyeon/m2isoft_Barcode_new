Public Structure _sMsg
    ...
    Shared sMsg_NoID As String = " 등록된 아이디가 아닙니다 !"
    ...
    Shared sMsg_NoAgreeCheck As String = "'동의' 란에 체크해주세요 !"
    Shared sMsg_InputInfo As String = "사용자 정보를 입력해주세요."
...
Public Structure _sMsg_Title
    ...
    Shared sMsgTitle_Reboot As String = "프로그램 재시작 안내"
...
Public Structure _sMsg_Question
    ...
    Shared sMsgQst_RebootOn As String = "환경설정 변경 후에는 프로그램 재시작이 필요합니다." & Chr(10) & Chr(10) &
                                        "프로그램을 재시작 하시겠습니까?"
